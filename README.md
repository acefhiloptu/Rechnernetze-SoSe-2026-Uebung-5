...
```console
user@server:~$ wget -O FPO2020.pdf https://www.uni-trier.de/fileadmin/studium/STUDIENVERLAUFSINFOS/ORDNUNGEN/PruefungsO/1-BA/FPO_BA/FPO_BA_Informatik/FPO_BA_Informatik_1F/FPO_BA_Informatik_1F_2020/FPO_BSc_1F-HF-NF_Informatik_2020-07-27.pdf
...
Eingabe: `ssh -L 8080:localhost:3000 user@server`
